...
func (in *ProviderClient) DeepCopyInto(out *ProviderClient) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProviderClient.
func (in *ProviderClient) DeepCopy() *ProviderClient {
	if in == nil {
		return nil
	}
	out := new(ProviderClient)
	in.DeepCopyInto(out)
	return out
}
